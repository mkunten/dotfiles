...
" mkdir if not exist
function! my#util#mkdir_if_not_exist(dir, force)
...
function! my#util#remove_file_if_empty(filename)
...
function! my#util#auto_cursorline(event)
  if a:event ==# 'WinEnter'
    setlocal cursorline
